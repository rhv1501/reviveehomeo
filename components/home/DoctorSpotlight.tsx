          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm font-semibold uppercase tracking-wider text-slate-500 mt-1">
                BHMS · Chief Homeopath
              </p>
            </div>

            <div className="space-y-4 text-slate-600 leading-relaxed">
              <p>
                With over 17 years of clinical experience, Dr. Nritiya Dave brings a rare blend of classical homeopathic training and modern diagnostic insight. Trained under a 40-year legacy of homeopathic practice, she approaches every case with deep empathy and precision.
              </p>
              <p>
                Her specialisation spans chronic skin conditions, hormonal disorders, paediatric care, and autoimmune diseases — conditions where conventional medicine often reaches its limits.
              </p>
            </div>
